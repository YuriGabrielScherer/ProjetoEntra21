...
public class Acao {
	...
	public void tirarProduto(String nome) {
		...
		// Verificando
		if (valorAtual == 0) {
			JOptionPane.showMessageDialog(null, "Não pode tirar de 0");
		} else {
			valorAtual--;
		}
